...
const App = () => {
  ...
  const getHighestRatedAnecdote = () => {
    let highestRating = 0;
    let highestRatedAnecdoteIndex = 0;
    votes.map((value, index) => {
      if (value > highestRating) {
        highestRating = value;
        highestRatedAnecdoteIndex = index;
      }
    });
    return anecdotes[highestRatedAnecdoteIndex];
  }
